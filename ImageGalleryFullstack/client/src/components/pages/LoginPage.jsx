    ...
    return (
        <div className="w-full h-[100vh] grid grid-cols-2">
            ...
            <div className=" bg-red-800 h-full overflow-hidden  hidden sm:block">
                ...
                <img className="w-full h-full object-cover" src="https://plus.unsplash.com/premium_photo-1671599016130-7882dbff302f?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
            </div>
            {/* right */}
            <div className="h-full flex items-center font-serif col-span-2 sm:col-span-1">
                ...
                <form action="#" className="grid grid-cols-4 w-11/12 lg:w-3/5 gap-3 mx-auto">
                    ...
                    <h2 className="col-span-4 text-center ">Login</h2>
                    ...
                    <p className="col-span-4 text-right text-xs">Don't have an account ? <Link className="text-blue-800" to='/signup'>Signup</Link></p>

                    <button
                        onClick={(event) => loginHandler(event)}
                        className=" col-span-2  col-start-2 py-2 bg-green-400 rounded-md active:scale-90">Login</button>
