...
export const Navbar = () => {
    ...
    return (
        <div className="w-full bg-[#2874F0] py-2 flex justify-center gap-4 sticky top-0 z-10">
            ...
            <div className="w-1/3 flex rounded-[3px] overflow-hidden">
                <input type="text" className="flex-1 pl-4 placeholder:text-[#757575] font-sans text-sm outline-none" placeholder="Search for products brand and more" />
                <button className="bg-[#FFFFFF] p-2 active:scale-90">
            ...
            {email ?
                <div onClick={() => navigate('/cart')} className="flex justify-center items-center gap-2 text-[#FFFFFF] cursor-pointer active:scale-95">
            ...
            {email ?
                <div onClick={() => navigate('/orders')} className="flex justify-center items-center gap-2 text-[#FFFFFF] cursor-pointer active:scale-95">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
            ...
            <div onClick={logoutHandler} className="cursor-pointer bg-[#FFFFFF] flex justify-center items-center rounded-[3px] active:scale-95">
