...
export const MenuBar = () => {
    ...
    return (
        <div className="flex justify-around sm:justify-center gap-1 sm:gap-10 md:gap-20 flex-nowrap py-3 shadow-md bg-white">
            ...
            <div onClick={() => navigate('/women"s clothing')} className="flex flex-col justify-center items-center cursor-pointer">
                <div className="w-10 h-10 overflow-hidden">
            ...
            <div onClick={() => navigate('/men"s clothing')} className="flex flex-col justify-center items-center cursor-pointer">
                <div className="w-10 h-10 overflow-hidden">
